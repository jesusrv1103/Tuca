  ...
  <div class="wrapper">
    ...
    <div class="header_bar">
      ...
      <div class="brand">
        ...
        <div class="logo" style="display:block"><img width="100%" style="margin-top: -25px;" src="assets/images/tec1.png"></div>
                ...
                <ul class="opened" style="display:block">
                  ...
                  <li class="theme_border"> <a href="javascript:void(0);"> <i class="fa fa-briefcase"></i> Administración <span class="plus"><i class="fa fa-plus"></i></span></a>
                    <ul>
                      <?php }  ?>
                      <li> 
                        <a href="?c=Maestro"> <span>&nbsp;</span> <i class="fa fa-circle"></i> 
                         <?php if (isset($maestro)){ ?><b class="theme_color"><?php } else { ?> <b> <?php } ?>Maestro</b>
                       </a> 
                     </li>
                     <br><br>
                     <li> 
                      <a href="?c=Materia"> <span>&nbsp;</span> <i class="fa fa-circle"></i> 
                       <?php if (isset($Materia)){ ?><b class="theme_color"><?php } else { ?> <b> <?php } ?>Materia</b>
                     </a> 
                   </li><br><br>
                   <?php if($_SESSION['tipoUsuario']==1){?> 

                   <li> 
                    <a href="?c=Alumno"> <span>&nbsp;</span> <i class="fa fa-circle"></i> 
                     <?php if (isset($alumno)){ ?><b class="theme_color"><?php } else { ?> <b> <?php } ?>Alumno</b>
                   </a> 
                 </li><br><br>
                 <li> 
                  <a href="?c=Kardex"> <span>&nbsp;</span> <i class="fa fa-circle"></i> 
                   <?php if (isset($kardex)){ ?><b class="theme_color"><?php } else { ?> <b> <?php } ?>Kardex</b>
                 </a> 
               </li><br><br>
               <li> 
